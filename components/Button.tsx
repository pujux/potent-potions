  ...
  return (
    <button
      ...
      className={classnames(
        `transition-all duration-200 text-${textColor} bg-${bgColor} hover:bg-${bgHoverColor} dark:bg-${darkBgColor} dark:hover:bg-${darkBgHoverColor} py-2 px-4 rounded font-medium text-center`,
        {
          'text-xs': size === 'sm',
          'text-md': size === 'md',
          'text-xl': size === 'lg',
